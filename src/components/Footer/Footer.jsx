            ...
            <div className='flex items-center lg:flex-row flex-col justify-between w-5/6 lg:pt-[10px]'>
                <div className='flex flex-col-reverse lg:flex-col items-center justify-between'>
                    <div className='flex'>
                        <a className='flex flex-col items-center m-5 cursor-pointer hover:opacity-20' href='https://www.facebook.com/profile.php?id=61561131252315&mibextid=ZbWKwL' target='_blank'>
                            ...
                            <p className='text-[#808080]'>FaceBook</p>
                        </a>
                        <div className='flex flex-col items-center m-5 cursor-pointer hover:opacity-20'>
                            ...
                            <p className='text-[#808080]'>Instagram</p>
                        </div>
                    </div>
                ...
                <div className='flex flex-col items-center justify-between p-[15px]'>
                    ...
                    <div className='pt-4'>
                        <div className='flex items-center p-2'>
                            ...
                            <p className='pl-4 text-[#808080]'>+91 9902220210</p>
                        </div>
                        <div className='flex items-center p-2'>
                            ...
                            <p className='pl-4 text-[#808080]'>infoezyscrap@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div className='pt-8 lg:pt-0'>
                    <div className="bg-white border border-[#5DA1E4] grid grid-cols-6 gap-2 rounded-xl p-2 text-sm h-fit">
                        ...
                        <button onClick={sendHappyFeedback} className="fill-slate-600 col-span-1 flex justify-center items-center rounded-lg p-2 duration-300 bg-slate-100 hover:border-slate-600 focus:fill-blue-200 focus:bg-blue-400 border border-[#5DA1E4]">
                        ...
                        <button onClick={sendUnHappyFeedback} className="fill-slate-600 col-span-1 flex justify-center items-center rounded-lg p-2 duration-300 bg-slate-100 hover:border-slate-600 focus:fill-blue-200 focus:bg-blue-400 border border-[#5DA1E4]">
                            <svg xmlnsXlink="http://www.w3.org/2000/svg" height="20px" viewBox="0 0 512 512">
                        ...
                        <button onClick={sendFeedback.bind(null, undefined)} className="bg-slate-100 stroke-slate-600 border border-[#5DA1E4] col-span-2 flex justify-center rounded-lg p-2 duration-300 hover:border-slate-600 hover:text-white focus:stroke-blue-200 focus:bg-blue-400">
