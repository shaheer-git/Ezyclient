...
function Footer() {
    return (
        <div className='h-auto lg:h-[50vh] w-full lg:w-screen bg-[#FFFBF4] flex flex-col items-center justify-center relative bottom-0'>
            <div className='flex items-center lg:flex-row flex-col justify-between w-5/6'>
                <div className='flex flex-col items-center justify-between'>
                    <div className='flex'>
                        <div className='flex flex-col items-center m-5 cursor-pointer hover:opacity-20'>
                            ...
                            <p className='text-[#5DA1E4]'>FaceBook</p>
                        </div>
                        <div className='flex flex-col items-center m-5 cursor-pointer hover:opacity-20'>
                            ...
                            <p className='text-[#5DA1E4]'>Instagram</p>
                        </div>
                    </div>
                    <p className='text-[#5DA1E4] pt-4'>Follow Us</p>
                </div>
                <div>Contact US
                </div>
                <div>
                    <div className="bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm h-fit">
            ...
            <div className='w-full flex flex-col items-end justify-center h-1/8'>
