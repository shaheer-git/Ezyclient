                ...
                <div className='flex justify-center items-center lg:flex-row flex-col'>
                    ...
                    <div className='mr-2 ml-2'>
                        <div className='h-auto lg:h-1/2 bg-[#FFFBF4] rounded-3xl'>
                            ...
                            <h2 className='font-semibold text-md lg:text-lg text-[#153E67] p-4 lg:p-8'>
            ...
            <div className='h-auto lg:h-1/2 bg-[#FFFBF4] rounded-3xl m-4' id='welcomeContainer'>
                ...
                <div className='p-6'>
                    ...
                    <div className='mb-6'>
                        ...
                        <p className='font-semibold text-md text-[#153E67] pt-3 pl-8'>As seasoned professionals in the vehicle scrapping industry, our team at Ezyscrap is dedicated to offering exceptional service. We handle all types of vehicles, from cars to bikes, ensuring they are dismantled and recycled with the utmost care. Whether your car has reached the end of its road life or you have a bike that's seen better days, our expertise guarantees that every component is managed correctly.</p>
                    </div>
                ...
                <div className='p-6'>
                    ...
                    <div className='mb-6'>
                        ...
                        <p className='font-semibold text-md text-[#153E67] pt-3 pl-8'>We accept a wide range of vehicles, including cars, bikes, and commercial vehicles. Whether your vehicle is running or not, we can handle it. Our team is equipped to manage all types of vehicles and ensure they are recycled properly.</p>
                    </div>
                    <div className='mb-6'>
                        <li className='font-extrabold text-lg text-[#153E67] m-2'>How do I get the best value for my scrap vehicle?</li>
                        <p className='font-semibold text-md text-[#153E67] pt-3 pl-8'>To get the best value for your scrap vehicle, ensure you provide accurate details when requesting a quote. Factors such as the vehicle's make, model, age, and condition play a role in determining its value. Our team will assess these factors and offer a competitive price based on current market rates.</p>
                    </div>
                    <div className='mb-6'>
                        <li className='font-extrabold text-lg text-[#153E67] m-2'>Is the scrapping process environmentally friendly?</li>
                        <p className='font-semibold text-md text-[#153E67] pt-3 pl-8'>Yes, at Ezyscrap, we are committed to environmentally friendly practices. We adhere to strict recycling standards to ensure that all materials from your vehicle are processed in a way that minimizes environmental impact. From fluid disposal to metal recycling, we prioritize sustainability throughout the scrapping process.</p>
                    </div>
                    <div className='mb-6'>
                        <li className='font-extrabold text-lg text-[#153E67] m-2'>What documents do I need to provide for scrapping my vehicle?</li>
                        <p className='font-semibold text-md text-[#153E67] pt-3 pl-8'>Typically, you will need to provide a copy of the vehicle's registration document, proof of identity, and any other relevant paperwork. Our team will guide you through the documentation process and ensure that everything is completed correctly.</p>
                    </div>
                </div>
            </div>
            <div className='mb-8'>
                ...
                <div className='flex items-center justify-center lg:flex-wrap flex-nowrap gap-2 w-screen'>
                    <div className='w-96 h-80 bg-[#FFFBF4] rounded-3xl m-4 relative'>
                        ...
                        <p className='font-semibold text-md text-[#153E67] text-center p-4'>“I needed to scrap my old car and was looking for reliable car scrap dealers near me. Ezyscrap provided an excellent service from start to finish. Their team was professional, and the entire process was hassle-free. Highly recommend!”</p>
                    ...
                    <div className='w-96 h-80 bg-[#FFFBF4] rounded-3xl m-4 relative'>
                        <svg height="55px" width="55px" version="1.1" id="Capa_1" className='rotate-180 ml-4 mt-4' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xmlSpace="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g id="right_x5F_quote"> <g> <path style={{ fill: "#dbdbdc" }} d="M0,4v12h8c0,4.41-3.586,8-8,8v4c6.617,0,12-5.383,12-12V4H0z"></path> <path style={{ fill: "#dbdbdc" }} d="M20,4v12h8c0,4.41-3.586,8-8,8v4c6.617,0,12-5.383,12-12V4H20z"></path> </g> </g> </g> </g></svg>
                        <p className='font-semibold text-md text-[#153E67] text-center p-4'>“Scrapping my bike was easier than I thought, thanks to Ezyscrap. They offered a fair price, and the pickup service was incredibly convenient. I appreciated their commitment to environmentally friendly practices.”</p>
                        <div className='absolute bottom-0 right-0 h-16 bg-[#dbdbdc] w-40 rounded-br-3xl rounded-tl-3xl flex items-center justify-center'>
                    ...
                    <div className='w-96 h-80 bg-[#FFFBF4] rounded-3xl m-4 relative'>
                        <svg height="55px" width="55px" version="1.1" id="Capa_1" className='rotate-180 ml-4 mt-4' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xmlSpace="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g id="right_x5F_quote"> <g> <path style={{ fill: "#dbdbdc" }} d="M0,4v12h8c0,4.41-3.586,8-8,8v4c6.617,0,12-5.383,12-12V4H0z"></path> <path style={{ fill: "#dbdbdc" }} d="M20,4v12h8c0,4.41-3.586,8-8,8v4c6.617,0,12-5.383,12-12V4H20z"></path> </g> </g> </g> </g></svg>
                        <p className='font-semibold text-md text-[#153E67] text-center p-4'>“I had an old commercial vehicle that needed scrapping, and Ezyscrap handled everything efficiently. The documentation was clear, and their customer service was top-notch. I'll definitely use their services again.”</p>
                        <div className='absolute bottom-0 right-0 h-16 bg-[#dbdbdc] w-40 rounded-br-3xl rounded-tl-3xl flex items-center justify-center'>
